export { default as CustomButton } from '@/components/atoms/CustomButton/CustomButton.vue';
export { default as CustomImage } from '@/components/atoms/CustomImage/CustomImage.vue';
